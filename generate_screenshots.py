...
def main():
    ...
    # Go directly to the test route, no login required!
    driver.get("http://127.0.0.1:5000/test_screenshots")
    time.sleep(2)
    
    # 1. Capture Full Metadata Run
    try:
        full_meta_card = driver.find_element(By.ID, "runCardDetails-full-meta")
    ...
    # 2. Capture Sparse Metadata Run
    try:
        sparse_meta_card = driver.find_element(By.ID, "runCardDetails-sparse-meta")
